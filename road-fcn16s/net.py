...
def fcn(split):
    n = caffe.NetSpec()
    n.data, n.label = L.Python(module='road_layers',
            layer='ROADContextSegDataLayer', ntop=2,
            param_str=str(dict(voc_dir='../data/road',
                context_dir='../data/road-context', split=split,
                seed=1337)))
