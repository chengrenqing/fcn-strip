...
def do_seg_tests(net, iter, save_format, dataset, layer='score', gt='label'):
    ...
    print '>>>', datetime.now(), 'Iteration', iter, 'pre-class IU',iu
...
if __name__ == '__main__':
    model_file = './snapshot/train_iter_8000.caffemodel'
    pro_file = './val.prototxt'
    ...
    #net = caffe.Net(pro_file,model_file,caffe.TEST)
    #do_seg_tests(net,1000,False,val)
